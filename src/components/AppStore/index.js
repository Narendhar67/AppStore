...
class AppStore extends Component {
  state = {activeTabId: 'SOCIAL', searchQ: ''}
        ...
        <ul className="tabsBox">
          {tabsList.map(tabDetails => (
            <TabItem
              ...
              TabSelect={this.selectTab}
              activeTabId={activeTabId}
            />
          ))}
        </ul>
        <ul className="appList-Container">
          {searchedList.map(appDetails => (
